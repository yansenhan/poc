...
class Visualizer:
    ...
    def __init__(self, config, dataset=None):
        ...
        aa=config["DUMP_LOCATION"]
        bb=config["EXP_NAME"]
        self.default_vis_dir = f"/home/lijixiang/poc/nanhu-src/{aa}/images/{bb}"
    ...
    def visualize(
       ...
       # import pdb;pdb.set_trace()
        ...
        if obstacle_map is not None:
            ...
            # 将灰度值复制到彩色图的每个通道
            color_img[:,:,0] = lidar_map  # Red channel
            color_img[:,:,1] = lidar_map  # Green channel
            color_img[:,:,2] = lidar_map  # Blue channel
            image_vis[V.Y1 : V.Y2, V.TOP_DOWN_X1 : V.TOP_DOWN_X2] = color_img 
       ...
       # import pdb;pdb.set_trace()
        ...
        if self.show_rl_obs and rl_obs_frame is not None:
           ...
           # third_person_image.save("/home/lijixiang/poc/nanhu-src/third_person_image.jpg")
          #  import pdb;pdb.set_trace()
            #third_person_image=cv2.imread("/home/lijixiang/poc/nanhu-src/nanhu/third_person_image.jpg")
            image_vis[V.Y1 : V.Y2, V.THIRD_PERSON_X1 : V.THIRD_PERSON_X2] = cv2.resize(   third_person_image,    (V.THIRD_PERSON_W, V.HEIGHT),            )
        ...
        if self.print_images:
           # import pdb;pdb.set_trace()
            self.vis_dir="/home/lijixiang/poc/datadump/images/eval_hssd"
            cv2.imwrite(
