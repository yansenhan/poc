...
class LowState(genpy.Message):
  _md5sum = "7e531980fef61bce444b1f441321eee6"
...
uint32[2] reserve"""
  __slots__ = ['levelFlag','commVersion','robotID','SN','bandWidth','imu','motorState','footForce','footForceEst','tick','wirelessRemote','reserve','crc']
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','unitree_legged_msgs/IMU','unitree_legged_msgs/MotorState[20]','int16[4]','int16[4]','uint32','uint8[40]','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       levelFlag,commVersion,robotID,SN,bandWidth,imu,motorState,footForce,footForceEst,tick,wirelessRemote,reserve,crc
