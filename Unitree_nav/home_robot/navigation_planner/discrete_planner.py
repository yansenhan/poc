...
class DiscretePlanner:
    ...
    def get_action(
        ...
        print("与目标的象差角度：",relative_angle_to_stg)
    ...
    def _get_short_term_goal(
       ...
       # import pdb;pdb.set_trace()
        ...
        if plan_to_dilated_goal:
            ...
            # import matplotlib.pyplot as plt
            # plt.imshow(self.dd)
            # plt.savefig("/nanhu-src/hi/bbb.png")
    ...
    def plan(
        ...
        Returns:
            ...
            closest_goal_map: (M, M) binary array denoting closest goal
             location in the goal map in geodesic distance
        """
        #print("超声数据最小的30个：",np.argsort(lidar[:, 0])[:30],"最大的30个：",np.argsort(lidar[:, 0])[330:])
       # import pdb;pdb.set_trace()
        ...
        print("$$$$$$$$$$$$$$$$$$$$$$$$$$","short_term_goal:",short_term_goal,"replan:",replan)
        ...
        return action, closest_goal_map, short_term_goal, dilated_obstacles,closest_goal_pt
