...
class HighState(genpy.Message):
  _md5sum = "5ac674d268805caf9dbab61ef025c30a"
...
float32 y
float32 z"""
  __slots__ = ['levelFlag','commVersion','robotID','SN','bandWidth','mode','imu','position','velocity','yawSpeed','footPosition2Body','footSpeed2Body','footForce','wirelessRemote','reserve','crc']
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','uint8','unitree_legged_msgs/IMU','float32[3]','float32[3]','float32','unitree_legged_msgs/Cartesian[4]','unitree_legged_msgs/Cartesian[4]','int16[4]','uint8[40]','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       levelFlag,commVersion,robotID,SN,bandWidth,mode,imu,position,velocity,yawSpeed,footPosition2Body,footSpeed2Body,footForce,wirelessRemote,reserve,crc
